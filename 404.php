...
get_header(); // Loads the header.php template. ?>
	...
	<main <?php hybrid_attr( 'error' ); ?>>
		...
		<h1 class="error-404-title entry-title"><?php _e( '404 Error: Page Not Found', 'piquant' ); ?></h1>

		<div class="entry-content">

			<p><?php printf( __( 'You tried going to %1$s, and it cannot be found. Sorry!', 'piquant' ), '<code>' . site_url( esc_url( $_SERVER['REQUEST_URI'] ) ) . '</code>' ); ?></p>
